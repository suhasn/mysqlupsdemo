...
2. Click on ‘New Instance’. And provide an instance name 'aws and the credentials and endpoint url details in the JSON format mentioned below and MySQL Hostname and Credentials. 
